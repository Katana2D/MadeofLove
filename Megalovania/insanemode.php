...
<body>
    <div class="insanemode">
        <h1 id="score">Pontuação: </h1>
        <div class="canvas-container">
            <canvas id="insanemodeCanvas" width="1000" height="600"></canvas>
            <!-- Música do jogo-->
            <div>
            ...
            <audio id="player" autoplay="autoplay" loop style="margin-right: auto; margin-top: 0;">
                <source src="music/A Million Gruesome Ways To Die (Original Game Soundtrack) (Instrumental)(MP3_160K).mp3" type="audio/mp3">
                <source src="music/A Million Gruesome Ways To Die (Original Game Soundtrack) (Instrumental)(MP3_160K).mp3" type="audio/mp3">
                Your browser does not support the audio tag.
            </audio>
        </div>
        <script src="insanemode.js"></script>
        <script>
            function goBack() {
