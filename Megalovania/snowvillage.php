...
<body>
    <div class="snowvillage">
        <h1 id="score">Pontuação: </h1>
        <div class="canvas-container">
            <canvas id="snowvillageCanvas" width="1000" height="600"></canvas>
            <!-- Música do jogo-->
            <div>
            ...
            <audio id="player" autoplay="autoplay" loop style="margin-right: auto; margin-top: 0;">
                <source src="music/Undertale OST_ 046 - Spear of Justice(MP3_160K).mp3" type="audio/mp3">
                <source src="music/Undertale OST_ 046 - Spear of Justice(MP3_160K).mp3" type="audio/mp3">
                Your browser does not support the audio tag.
            </audio>
        </div>
        <script src="snowvillage.js"></script>
        <script>
            function goBack() {
